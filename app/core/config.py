...
class Settings(BaseSettings):
    ...
    ai_provider: Literal["openai", "anthropic", "groq"] = Field(default="groq", env="AI_PROVIDER")
    ...
    groq_chat_model: str = Field(default="deepseek-r1-distill-llama-70b", env="GROQ_CHAT_MODEL")
